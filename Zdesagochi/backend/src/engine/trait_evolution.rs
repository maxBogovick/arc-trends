...
use crate::engine::types::{
    clamp, CoreMemory, EmergentStateType, EvolutionRecord, TraitKey, TraitVector,
};
...
fn personality_position(id: &str) -> TraitVector {
    ...
    match id {
        "playful" => {
            map.insert(TraitKey::Vitality, 70.0); map.insert(TraitKey::Sociality, 60.0);
            map.insert(TraitKey::Order, 30.0); map.insert(TraitKey::Appetite, 50.0);
            map.insert(TraitKey::Caution, 25.0); map.insert(TraitKey::Curiosity, 75.0);
        }
        "drowsy" => {
            map.insert(TraitKey::Vitality, 30.0); map.insert(TraitKey::Sociality, 50.0);
            map.insert(TraitKey::Order, 60.0); map.insert(TraitKey::Appetite, 45.0);
            map.insert(TraitKey::Caution, 55.0); map.insert(TraitKey::Curiosity, 35.0);
        }
        "foodie" => {
            map.insert(TraitKey::Vitality, 55.0); map.insert(TraitKey::Sociality, 55.0);
            map.insert(TraitKey::Order, 40.0); map.insert(TraitKey::Appetite, 90.0);
            map.insert(TraitKey::Caution, 35.0); map.insert(TraitKey::Curiosity, 60.0);
        }
        "bold" => {
            map.insert(TraitKey::Vitality, 85.0); map.insert(TraitKey::Sociality, 45.0);
            map.insert(TraitKey::Order, 25.0); map.insert(TraitKey::Appetite, 50.0);
            map.insert(TraitKey::Caution, 10.0); map.insert(TraitKey::Curiosity, 65.0);
        }
        "zen" => {
            map.insert(TraitKey::Vitality, 45.0); map.insert(TraitKey::Sociality, 65.0);
            map.insert(TraitKey::Order, 75.0); map.insert(TraitKey::Appetite, 40.0);
            map.insert(TraitKey::Caution, 70.0); map.insert(TraitKey::Curiosity, 55.0);
        }
        "anxious" => {
            map.insert(TraitKey::Vitality, 40.0); map.insert(TraitKey::Sociality, 40.0);
            map.insert(TraitKey::Order, 35.0); map.insert(TraitKey::Appetite, 50.0);
            map.insert(TraitKey::Caution, 85.0); map.insert(TraitKey::Curiosity, 50.0);
        }
        "feral" => {
            map.insert(TraitKey::Vitality, 80.0); map.insert(TraitKey::Sociality, 25.0);
            map.insert(TraitKey::Order, 15.0); map.insert(TraitKey::Appetite, 65.0);
            map.insert(TraitKey::Caution, 30.0); map.insert(TraitKey::Curiosity, 70.0);
        }
        "sage" => {
            map.insert(TraitKey::Vitality, 50.0); map.insert(TraitKey::Sociality, 60.0);
            map.insert(TraitKey::Order, 70.0); map.insert(TraitKey::Appetite, 45.0);
            map.insert(TraitKey::Caution, 65.0); map.insert(TraitKey::Curiosity, 80.0);
        }
        "pristine" => {
            map.insert(TraitKey::Vitality, 50.0); map.insert(TraitKey::Sociality, 45.0);
            map.insert(TraitKey::Order, 90.0); map.insert(TraitKey::Appetite, 40.0);
            map.insert(TraitKey::Caution, 60.0); map.insert(TraitKey::Curiosity, 45.0);
        }
        "empath" => {
            map.insert(TraitKey::Vitality, 50.0); map.insert(TraitKey::Sociality, 90.0);
            map.insert(TraitKey::Order, 50.0); map.insert(TraitKey::Appetite, 45.0);
            map.insert(TraitKey::Caution, 40.0); map.insert(TraitKey::Curiosity, 55.0);
        }
        "greedy" => {
            map.insert(TraitKey::Vitality, 60.0); map.insert(TraitKey::Sociality, 35.0);
            map.insert(TraitKey::Order, 55.0); map.insert(TraitKey::Appetite, 70.0);
            map.insert(TraitKey::Caution, 50.0); map.insert(TraitKey::Curiosity, 65.0);
        }
        "melancholic" => {
            map.insert(TraitKey::Vitality, 35.0); map.insert(TraitKey::Sociality, 55.0);
            map.insert(TraitKey::Order, 45.0); map.insert(TraitKey::Appetite, 40.0);
            map.insert(TraitKey::Caution, 60.0); map.insert(TraitKey::Curiosity, 60.0);
        }
        "chaotic" => {
            map.insert(TraitKey::Vitality, 60.0); map.insert(TraitKey::Sociality, 50.0);
            map.insert(TraitKey::Order, 10.0); map.insert(TraitKey::Appetite, 55.0);
            map.insert(TraitKey::Caution, 20.0); map.insert(TraitKey::Curiosity, 85.0);
        }
        "stoic" => {
            map.insert(TraitKey::Vitality, 55.0); map.insert(TraitKey::Sociality, 30.0);
            map.insert(TraitKey::Order, 80.0); map.insert(TraitKey::Appetite, 40.0);
            map.insert(TraitKey::Caution, 75.0); map.insert(TraitKey::Curiosity, 40.0);
        }
        "adventurer" => {
            map.insert(TraitKey::Vitality, 75.0); map.insert(TraitKey::Sociality, 50.0);
            map.insert(TraitKey::Order, 20.0); map.insert(TraitKey::Appetite, 55.0);
            map.insert(TraitKey::Caution, 15.0); map.insert(TraitKey::Curiosity, 90.0);
        }
        "paranoid" => {
            map.insert(TraitKey::Vitality, 45.0); map.insert(TraitKey::Sociality, 20.0);
            map.insert(TraitKey::Order, 60.0); map.insert(TraitKey::Appetite, 45.0);
            map.insert(TraitKey::Caution, 90.0); map.insert(TraitKey::Curiosity, 50.0);
        }
        _ => {
            for &key in TraitKey::all() { map.insert(key, 50.0); }
        }
    }
    map
}
...
pub fn dynamic_radius(id: &str, age_hours: f64) -> f64 {
    ...
    if age_days < 7.0 { base - 3.0 }
    else if age_days < 30.0 { base }
    else if age_days < 90.0 { base + 4.0 }
    else { base + 8.0 }
}

pub fn euclidean_distance(a: &TraitVector, b: &TraitVector) -> f64 {
    let sum: f64 = TraitKey::all().iter().map(|k| {
        let av = a.get(k).copied().unwrap_or(50.0);
        let bv = b.get(k).copied().unwrap_or(50.0);
        (av - bv).powi(2)
    }).sum();
    (sum / TraitKey::all().len() as f64).sqrt()
}
...
pub fn trigger_catharsis(state: &mut EngineState, now: DateTime<Utc>) {
    ...
    add_core_memory(state, "rare", "🌅", memory_text, "system", "sociality", "up", None, now);
}
...
pub fn check_evolution(state: &mut EngineState) {
    ...
    let age_hours = 0.0; // simplified, using default
    ...
    if current_depth_abs < HYSTERESIS { return; }
    if state.ticks_in_target_zone < STABILITY_SYNCS { return; }

    let readiness = ((state.ticks_in_target_zone as f64 / STABILITY_SYNCS as f64) * 100.0).min(100.0).round();
    let relevant_memories: Vec<String> = state.core_memories.iter()
...
pub fn accept_evolution(state: &mut EngineState) -> bool {
    ...
    if let Some(ref mut layers) = state.state_layers.cognitive {
        layers.retain(|s| s.state_type != EmergentStateType::IdentityCrisis
    ...
    add_core_memory(state, "rare", to_emoji, &text, "system", "vitality", "origin",
        Some(&to.clone()), chrono::Utc::now());
...
pub fn detect_singularity(state: &EngineState) -> Option<Vec<String>> {
    let age_hours = 0.0;
    let personalities = crate::engine::personalities::get_personalities();
    let mut inside: Vec<(String, f64)> = personalities.iter()
        .map(|p| {
            let depth = depth_of_immersion(&state.trait_vector, &p.id, age_hours);
            (p.id.clone(), depth)
        })
...
pub fn add_core_memory(
    ...
    let rare: Vec<_> = state.core_memories.drain(..).filter(|m| m.tier == "rare").collect();
    let common: Vec<_> = state.core_memories.drain(..).filter(|m| m.tier == "common").collect();
    ...
    let mut rare2: Vec<_> = state.core_memories.iter().filter(|m| m.tier == "rare").cloned().collect();
    let mut common2: Vec<_> = state.core_memories.iter().filter(|m| m.tier == "common").cloned().collect();
    ...
    state.core_memories.sort_by(|a, b| b.timestamp.cmp(&a.timestamp));
