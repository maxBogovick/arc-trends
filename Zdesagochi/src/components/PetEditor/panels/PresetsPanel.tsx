...
const BUILT_IN_PRESETS: { id: string; name: string; emoji: string; tag: string; accent: string; data: PresetData }[] = [
  ...
  },
  {
    ...
    data: {
      ...
      equippedArmsId: 'claws',
      equippedLegsId: 'claw_feet',
  ...
  },
  {
    ...
    data: {
      ...
      equippedArmsId: 'long_arms',
      equippedLegsId: 'hooves',
      equippedTailId: 'fan',
