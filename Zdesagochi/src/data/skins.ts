...
export type EyeStyle =
  ...
  | 'cute'      // Большие kawaii-глаза со звёздочкой
  | 'pixel'     // 8-bit пиксельные
  | 'closed'    // Закрытые дуги (смущение/улыбка)
  | 'wink';     // Левый закрыт, правый открыт
...
export const SKINS: SkinDefinition[] = [
  // ─── Бесплатные стартовые скины ───────────────────────────────────────────
  {
    id: 'default',
    name: 'Нулевой',
    tagline: 'Чистый холст',
    description: 'Никаких эффектов, никаких наложений. Просто питомец в чистом виде.',
    emoji: '◼',
    price: 0,
    rarity: 'common',
    colors: { body1: '#D8D8E8', body2: '#A8A8C0', glow: '#FFFFFF', cheek: '#C8C8DC' },
    eyeStyle: 'normal',
    eyeColor: '#1A1A3C',
    overlay: 'none',
    animStyle: 'float',
